export default function Footer() {
  return (
    <footer className="bg-violet-900 px-6 py-14 lg:py-[4.25rem]">
      <div className="mx-auto flex max-w-5.5xl flex-col items-center lg:flex-row lg:items-start lg:justify-between lg:gap-20">
        ...
        <div className="mt-12 grid gap-11 text-center lg:mt-0 lg:grid-cols-4 lg:gap-8 lg:text-start">
          <section>
